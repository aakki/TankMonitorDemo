...
using TankMonitorDemo.EntityFrameworkCore.Seed;
...
namespace TankMonitorDemo.EntityFrameworkCore
{
    ...
    public class TankMonitorDemoEntityFrameworkModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TankMonitorDemoEntityFrameworkModule).GetAssembly());
        }
